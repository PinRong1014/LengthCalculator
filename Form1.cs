    ...
    public partial class Form1: Form
    {
        ...
        private void txtM_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (double.TryParse(strInput, out douOutput) == true)
            {
                ...
                txtIn.Text = string.Format("{0:0.##########}", douOutput * 39.3700787);
                txtFt.Text = string.Format("{0:0.##########}", douOutput * 3.2808399);
                txtYard.Text = string.Format("{0:0.##########}", douOutput * 1.0936133);
            }
            else
            {
                txtInfo.Text = "請輸入數字";
        ...
        private void txtFt_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (double.TryParse(strInput, out douOutput) == true)
            {
                ...
                txtYard.Text = string.Format("{0:0.##########}", douOutput * 0.3333333);
            }
            else
            {
                txtInfo.Text = "請輸入數字";
